...
public class SoftKeyboardUtils {
    ...
    public static boolean isSoftShowing(Activity activity) {
        ...
        return screenHeight > rect.bottom+getSoftButtonsBarHeight(activity);
    }
    boolean isVisiableForLast = false;

    public void addOnSoftKeyBoardVisibleListener(final Activity activity) {
        ...
        decorView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                //获得键盘高度
                int keyboardHeight = hight - displayHight - Utils.calcStatusBarHeight(activity);
